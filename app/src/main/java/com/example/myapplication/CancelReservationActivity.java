        ...
        reserveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    String selectedNumberOfPeople = numberOfPeopleEditText.getText() != null ? numberOfPeopleEditText.getText().toString() : "";
                    String selectedName = nameEditText.getText() != null ? nameEditText.getText().toString() : "";
                    String selectedEmail = emailEditText.getText() != null ? emailEditText.getText().toString() : "";
                    String selectedPhone = phoneEditText.getText() != null ? phoneEditText.getText().toString() : "";

                    // Verifică disponibilitatea și actualizează baza de date Firebase
                    checkAvailabilityAndUpdateFirebase(hallIdCurrent, selectedStartTime, selectedEndTime);
                } catch (Exception e) {
                    Log.e("ReservationActivity", "Error occurred: " + e.getMessage(), e);
                    Toast.makeText(CancelReservationActivity.this, "An error occurred", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
        ...
        hallAvailabilityRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.hasChild(timeSlotKey)) {
                    ...
                    if (availability != null && availability.equals("Indisponibil")) {
                        // The time slot is available, reserve it
                        Map<String, Object> updateValues = new HashMap<>();
                        updateValues.put(timeSlotKey, "Disponibil");
                        ...
                        hallAvailabilityRef.updateChildren(updateValues)
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        ...
                                        Toast.makeText(CancelReservationActivity.this, "Reservation successful", Toast.LENGTH_SHORT).show();
                                    }
                                })
                                .addOnFailureListener(new OnFailureListener() {
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        ...
                                        Toast.makeText(CancelReservationActivity.this, "Failed to reserve the time slot", Toast.LENGTH_SHORT).show();
                                    }
                                });
                    } else {
                        // The time slot is unavailable
                        Toast.makeText(CancelReservationActivity.this, "Selected time slot is unavailable", Toast.LENGTH_SHORT).show();
                    }
                } else {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CancelReservationActivity.this, "Failed to check availability", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
